...
const translations = {
  ...
  hero_desc: {
    fr: "PR@MPT génère des prompts optimisés pour chaque IA — OpenAI GPT, DeepSeek Coder, DeepAI et RunwayML. Obtenez les meilleurs résultats en texte, code, image et vidéo, automatiquement.",
    en: "PR@MPT generates optimized prompts for every AI — OpenAI GPT, DeepSeek Coder, DeepAI and RunwayML. Get the best results in text, code, image and video, automatically.",
  },
  ...
  pricing_starter_f1: { fr: "150 crédits / mois", en: "150 credits / month" },
  pricing_starter_f2: { fr: "Tous les modèles IA", en: "All AI models" },
  pricing_starter_f3: { fr: "Historique illimité", en: "Unlimited history" },
  pricing_pro_f1: { fr: "450 crédits / mois", en: "450 credits / month" },
  pricing_pro_f2: { fr: "Tous les modèles IA", en: "All AI models" },
  pricing_pro_f3: { fr: "Support prioritaire", en: "Priority support" },
  pricing_expert_f1: { fr: "1000 crédits / mois", en: "1000 credits / month" },
  pricing_expert_f2: { fr: "Tous les modèles IA", en: "All AI models" },
  pricing_expert_f3: { fr: "Support prioritaire + accès anticipé", en: "Priority support + early access" },
