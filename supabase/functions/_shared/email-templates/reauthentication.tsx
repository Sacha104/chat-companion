  ...
  <Html lang="fr" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={footer}>
          Ce code expirera bientôt. Si vous n'avez pas demandé ce code, ignorez cet e-mail.
        </Text>
      </Container>
    </Body>
  </Html>
...
const codeStyle = { fontFamily: 'Courier, monospace', fontSize: '22px', fontWeight: 'bold' as const, color: 'hsl(160, 60%, 45%)', margin: '0 0 30px' }
